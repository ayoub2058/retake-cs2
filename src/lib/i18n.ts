...
const messages = {
  en: {
    ...
    aiGeneratedSummary: "AI-generated match summary",
    aiCoachAnalysis: "AI Coach Analysis",
    personalizedCoaching: "Personalized tactical coaching",
    clickToExpand: "Click to expand full card",
    ...
    aiCoachingTips: "AI Coaching Tips",
    noCoachingTips: "No coaching tips yet",
    noCoachingTipsDesc: "Play matches and the AI coach will automatically analyze your games and provide tactical feedback.",
    viewMatch: "View Match",
    bestMap: "Best Map",
    mapBreakdown: "Map Breakdown",
    winRateByMap: "Win Rate by Map",
    statusLabel: "Status",
    botSendPrefs: "Bot Messages",
    botSendPrefsDesc: "Choose what the bot sends you after each match.",
    sendGameCard: "Game Stats Card",
    sendGameCardDesc: "Visual stats card with your match performance",
    sendCoachTip: "AI Coach Tip",
    sendCoachTipDesc: "Personalized tactical coaching from the AI",
    sendMatchLink: "Dashboard Link",
    sendMatchLinkDesc: "Link to view full match stats on the website",
  },
  ar: {
    ...
    aiGeneratedSummary: "ملخص المباراة بالذكاء الاصطناعي",
    aiCoachAnalysis: "تحليل المدرب الذكي",
    personalizedCoaching: "تدريب تكتيكي مخصص",
    clickToExpand: "انقر لعرض البطاقة كاملة",
    readFullAnalysis: "اقرأ التحليل الكامل",
    showLess: "عرض أقل",
    recentForm: "الشكل",
    streak: "سلسلة",
    aiCoaching: "التدريب الذكي",
    coachingHistory: "سجل التدريب",
    aiCoachingTips: "نصائح المدرب الذكي",
    noCoachingTips: "لا توجد نصائح تدريبية بعد",
    noCoachingTipsDesc: "العب مباريات وسيقوم المدرب الذكي بتحليل ألعابك تلقائيًا وتقديم ملاحظات تكتيكية.",
    viewMatch: "عرض المباراة",
    bestMap: "أفضل خريطة",
    mapBreakdown: "تفصيل الخرائط",
    winRateByMap: "نسبة الفوز حسب الخريطة",
    statusLabel: "الحالة",
    botSendPrefs: "رسائل البوت",
    botSendPrefsDesc: "اختر ما يرسله لك البوت بعد كل مباراة.",
    sendGameCard: "بطاقة إحصائيات اللعبة",
    sendGameCardDesc: "بطاقة مرئية بأدائك في المباراة",
    sendCoachTip: "نصيحة المدرب الذكي",
    sendCoachTipDesc: "تدريب تكتيكي مخصص من الذكاء الاصطناعي",
    sendMatchLink: "رابط لوحة التحكم",
    sendMatchLinkDesc: "رابط لعرض إحصائيات المباراة كاملة على الموقع",
  },
} as const;
